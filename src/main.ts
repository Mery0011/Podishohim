...
const nextButtons = document.querySelectorAll<HTMLButtonElement>(".next-button");
const card = document.querySelector<HTMLElement>(".birthday-card");
...
function fadeOutMusic(duration: number = 10000): void {
...
function createSparkles(
    ...
    const sparkleCounts: Record<number, number> = {
...
function createFinalSparkles(): void {
